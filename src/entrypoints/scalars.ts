...
/**
 * Taken from: https://github.com/prisma/nexus-prisma
 */
 ...
 *   import NexusPrismaScalars from 'nexus-prisma-crud/scalars'
 *
 *   makeSchema({
 ...
 *
 *   import { makeSchema, objectType } from 'nexus'
 *   import * as NexusPrismaScalars from 'nexus-prisma-crud/scalars'
 *
 *   makeSchema({
 *     types: [NexusPrismaScalars],
 *   })
 ...
 *
 *   import { makeSchema, objectType } from 'nexus'
 *   import { Json } from 'nexus-prisma-crud/scalars'
 *
 *   makeSchema({
 *     types: [Json],
 *   })
